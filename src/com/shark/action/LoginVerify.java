...
/**
 * Servlet implementation class LoginVerify 登录验证，登录成功后，会将相应的信息存入session中 包括是否登录
 * Login : string 已登录为true roleid: int 角色类型 id : int 用户ID username: String 用户姓名
 * 四个字段
 */
...
public class LoginVerify extends HttpServlet {
	...
	/**
	 * 返回给客户端json代码格式是 { "success": true, "msg": "xxx" } success 是否登录成功
	 * msg登录失败包含的信息
	 * 
